...
def _deps_impl(module_ctx):
    ...
    maybe(
        ...
        url = "https://github.com/HowardHinnant/date/archive/1a70f8c8a8893fd06fdedb9d1b9e73d6c114bf99.tar.gz",
        sha256 = "848d388bdeccba7889ec86b6ef46d155882c09124fd2e9114498647e1539fb62",
        strip_prefix = "date-1a70f8c8a8893fd06fdedb9d1b9e73d6c114bf99",
